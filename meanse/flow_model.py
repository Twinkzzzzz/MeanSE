...
from meanse.sampling import  get_white_box_solver
...
class FlowSEModel(L.LightningModule):
    def __init__(self, cfg: Config):
        ...
        print("### FlowSEModel init ###")
        print("train_set_path:", cfg.train_set_path, flush=True)
        print("dynamic_mixing:", cfg.train_set_dynamic_mixing, flush=True)
        print("valid_set_path:", cfg.valid_set_path, flush=True)
    ...
    def validation_step(self, batch, batch_idx):
        loss = self.forward_step(batch)
        self.log('val_loss', loss, on_step=True, prog_bar=True, on_epoch=True, sync_dist=True)
