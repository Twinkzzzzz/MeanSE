...
from meanutils.generate_data_param import get_parser
from meanutils.rir_utils import estimate_early_rir
...
def wind_noise(
    ...
    if on_the_fly:
        tmp_dir = Path("/tmp/simulation_tmp_wjh")
    else:
    ...
    if True or normalize_amplitude:
        scale = 0.9 / max(
